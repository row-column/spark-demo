 ...
 * 　　　　　┗┻┛　┗┻┛
 * ━━━━━━感觉萌萌哒━━━━━━
 * Module Desc:GenerateRandomText
 * User: wangyue
 * DateTime: 15-5-9下午8:16
 */
object GenerateRandomText {
  def main(args: Array[String]) {
    val outputPath = new File("//home/wangyue/opt/spark/spark-1.3.1-bin-hadoop2.3/data/RandomText/randomText-10MB.txt")
