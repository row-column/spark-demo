...
/*public static final List<String> exampleApacheLogs = new ArrayList<String>()*//*Lists.newArrayist(*//*
...
public static class Stats implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        JavaRDD<String> dataSet = (args.length == 1) ? jsc.textFile(args[0]) :null; /*jsc.parallelize(exampleApacheLogs);*/

        JavaPairRDD<Tuple3<String, String, String>, Stats> extracted = dataSet.mapToPair(new PairFunction<String,
